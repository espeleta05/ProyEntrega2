...
(function () {
  ...
  function renderChart() {
    ...
    var chartEl = document.getElementById('chartPacientesSemana');
    ...
    if (!Array.isArray(chartData) || chartData.length === 0) {
      chartEl.innerHTML = '<p style="text-align:center;padding:32px;color:var(--md-on-surface-variant);">Sin datos esta semana.</p>';
      return;
    }
  ...
  function waitForHighcharts(attempts) {
    ...
    if (attempts <= 0) {
      var el = document.getElementById('chartPacientesSemana');
